...
<div class="card-panel hoverable">
    <?php $form = ActiveForm::begin(['options' => ['enctype' => 'multipart/form-data']]); ?>
        ...
        <p class="flow-text">Add Kid Partner Details</p>
    ...
    <div class="row">
        <div class="input-field col s2"><label for="icon_prefix">Full Name</label></div>
        <div class="input-field col s3">
            <?= $form->field($model, 'kid_name')->textInput(['maxlength' => true])->label(false); ?>
        </div>
</div>
 ...
 <div class="row">
      ...
      <div class="input-field col s2">
        <?php echo $form->field($model, 'k_gender')->dropDownList([0 =>'Select...','Male' => 'Male', 'Female' => 'Female',])->label(FALSE); ?>
      </div>

       <div class="input-field col s1"><label for="icon_prefix">Age</label></div>
        <div class="input-field col s1">
            <?= $form->field($model, 'k_age')->textInput(['maxlength' => true])->label(false); ?>
        </div>
</div>
<div class="row">
         <div class="input-field col s2"><label for="icon_prefix">Relation With Primary</label></div>
        <div class="input-field col s3">
            <?= $form->field($model, 'k_relation')->textInput(['maxlength' => true])->label(false); ?>
        </div>

         <div class="input-field col s1"><label for="icon_prefix">ID Type</label></div>
      <div class="input-field col s2">
        <?php echo $form->field($model, 'k_id_type')->dropDownList(['Passport' => 'Passport', 'Aadhar Card' => 'Aadhar Card', 'Driving Licence' => 'Driving Licence','Voter ID' => 'Voter ID'])->label(FALSE); ?>
      </div>
      
      <div class="input-field col s1"><label for="icon_prefix">ID Number</label></div>
      <div class="input-field col s3">
        <?= $form->field($model, 'k_id_number')->textInput(['maxlength' => true])->label(false) ?>
      </div>
      </div>
