...
{
var zipId = $(this).val();
$.get('index.php?r=create-bookings/get-city-province',{ zipId : zipId }, function(data)
{
var data = $.parseJSON(data);
$('#create-bookings-rate').attr('value',data.rate);
$('#create-bookings-room_type').attr('value',data.room_type);
alert(data.rate);
});
});
JS;
